...
<head>
  ...
  <style>
    ...
    <body>
      ...
      <div class="row">
       ...
       <div class="col-md-8 col-md-offset-2">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="database" value="__dbname__">
        </div>
        <div class="form-group">
          <label for="username" class="control-label">Username</label>
          <input type="text" class="form-control" name="username" value="__dbusername__">
        </div>
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="password" value="__dbpassword__">
        </div>
        <hr />
        <div class="text-left">
     ...
     <div class="form-group">
      <div class="form-group">
       <label for="base_url" class="control-label">Base URL <a href="https://support.deifysolutions.com" target="_blank">Read more...</a></label>
   ...
   <div class="form-group">
     ...
     <input type="email" class="form-control" name="admin_email" id="admin_email" value="__superadminemail__" required>
   </div>
   <div class="row">
    <div class="col-md-6">
      <div class="form-group">
